...
{
	public class RedmiWatch3RleCompressor : IDataCompressor
	{
		private bool isList;
		...
		public RedmiWatch3RleCompressor(bool withAlfa, bool isList, bool noCompress = false)
		{
			this.withAlfa = withAlfa;
			this.isList = isList;
